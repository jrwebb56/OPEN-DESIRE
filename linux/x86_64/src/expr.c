...
/*   Registered Copyright 2009 G.A. Korn    - old version      9/13/93 */
...
double ROUND(double arg)            /* returns rounded double argument */
{
    int rj ;
...
int getsub(ptr q)      /* compute index for array, with subscripts NOT    */
{     /* reversed ; on entry, gi points to [, on exit */
...
double getoprnd() {       /* evaluate operand ; on entry, gi points to */
	...
	if (p->valptr>0) {                 /* user-defined function */
		...
		pp=pp->next ;
            ...
            switch (p->valptr) {
		/*ln*/  
		case -1  : if (arg<=0) derror(9) ; arg1=log(arg) ; break ;
		    /*tim*/  
		case -2  : arg1=(double)clock()/1.0E+06 ; break ;
		    /*sin*/  
		case -3  : arg1=sin(arg) ; break ;
		    /*cos*/  
		case -4  : arg1=cos(arg) ; break ;
		    /*exp*/  
		case -5  : arg1=exp(arg) ; break ;
		    /*abs*/  
		case -6  : arg1=fabs(arg) ; break ;
		    /*sqrt*/  
		case -7  : if (arg<0) derror(47) ; arg1=sqrt(arg) ; break ;
		    /*trnc*/  
		case -8  : if (arg>maxint || arg< -maxint) derror(20) ;
		    arg1=lcount=arg ; break ;
		    /*lim*/  
		case -9  : if (arg>0) arg1=arg ; else arg1=0 ; break ;
		    /*sgn*/  
		case -10  : if (arg<0) arg1= -1 ; else if (arg>0) arg1=1 ;
		else arg1=0 ; break ;
		/*ran*/  
		case -11  : arg1=2*drand48()-1.0 ;
/**** 2*d_lcran_()-1.0 ;    ****/   
/*** arg1=(double)rand()*ranscale-1.0 ; **** GNU ***/
		    break ;
		    /*atan*/  
		case -12  : arg1=atan(arg) ; break ;
		    /*round*/  
		case -13  : arg1=ROUND(arg) ; break ;
		    /*Re*/  
		case -14  : arg1=arg ; break ;
		    /*Im*/  
		case -15  : arg1=sign ; break ;
		    /*Cabs*/  
		case -16  : arg1=sqrt(arg*arg+sign*sign) ; break ;
		    /*Arg*/  
		case -17  : arg1=atan2(sign,arg) ; break ;
		    /*Conjug*/  
		case -18  :
		    /*expj*/  
		case -19  :  errnum=31 ; return 0 ;
		    /*log*/  
		case -20  : if (arg<=0) derror(9) ; arg1=log10(arg) ; break ;
		    /*tan*/  
		case -21  : arg1=tan(arg) ; break ;
		    /*sinh*/  
		case -22  : arg1=sinh(arg) ; break ;
		    /*cosh*/  
		case -23  : arg1=cosh(arg) ; break ;
		    /*acos*/  
		case -24  : arg1=acos(arg) ; break ;
		    /*asin*/  
		case -25  : arg1=asin(arg) ; break ;
		    /*tanh*/  
		case -26  : arg1=tanh(arg) ; break ;
		    /*atan2*/ 
		case  -27 : if (warea[gi++]!=',') derror(44) ;
		    sign=evalexp() ; if (errnum) derror(errnum) ;
		    arg1=atan2(arg,sign) ;
		    break ;
		    /*swtch*/ 
		case -28 : if (arg>0) arg1=1 ; else arg1=0 ; break ;
		    /*SAT*/   
		case -29 : if (arg<0) arg1=0 ; else if (arg>1)
		    arg1=1 ; else arg1=arg ; break ;
		/* -30 is for NEUNET */
		/*sat*/   
		case -31 : if (arg< -1) arg1= -1 ; else if (arg>1)
		    arg1=1 ; else arg1=arg ; break ;
		/*deadz*/  
		case -32 : if (arg< -1) arg1=arg+1 ; else if (arg>1)
		    arg1=arg-1 ; else arg1=0 ; break ;
		/*deadc*/  
		case -33 : if (arg< -1) arg1= -1 ; else if (arg>1)
		    arg1=1 ; else arg1=0 ; break ;
		/*rect*/  
		case -34 : if (arg<1 && arg> -1) arg1=1 ;
		else arg1=0 ; break ;
		/*comp*/  
		case -35 : if (warea[gi++]!=',') derror(44);
		    arg1=evalexp() ; if (errnum) derror(errnum) ;
		    if (warea[gi++]!=',') derror(44) ;
		    sign=evalexp() ; if (errnum) derror(errnum) ;
		    if (arg>0) arg1=sign ; break ;
		    /*tri*/  
		case -36 : if (arg<0) arg1=arg+1 ;
		else arg1=1-arg ; break ;
		/*sigmoid*/  
		case -37 : arg1=1/(exp(-arg)+1) ; break ;
		    /*SIGMOID*/  
		case -38 : if (arg>0) arg1=arg*arg/(arg*arg+1) ;
		else arg1=0.0 ; break ;
		/*sinc*/  
		case -39 : if (arg==0) arg1=1 ;
		else arg1=sin(arg)/arg ; break ;
		/*gauss*/
		case -43 : arg1=sqrt(-2*log(drand48()))*cos(2*PI*drand48()) ; break ;  /** &&& <***/
...
double evalexp() {                     /* evaluate a REAL expression */
	...
	switch (warea[wptr]) {
	    ...
	    case '*' : accum*=relval[gjj++] ; break ;
	    case '/' : if (accum==0) derror(5) ; 
		accum=relval[gjj++]/accum ; break ;
	    default  : if (accum==2) { accum=relval[gjj]*relval[gjj] ; 
	    gjj++ ; }
            else {
