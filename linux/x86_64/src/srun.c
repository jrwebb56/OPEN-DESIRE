...
/*             Registered Copyright 2007  G.A. Korn                    */
...
/*   keep DT from exceeding TMAX/(NN-1)    8/19/05  */
/*   extra space in "type" listings "   8/22/07 */

/** for threaded cose V14 9/1/07 **/
/* ------------------------------------------------------------------- */
...
extern void derror() ;   extern void drun00() ;   extern void DRIVE() ;    /*    <****/
...
void typex() {                                         /* TYPE routine */
    ...
    lj=1 ; do fprintf(outptr,"%#13.5e ",*bufdisp[lj++]) ;   /* extra space! */
