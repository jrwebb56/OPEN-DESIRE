...
/*      Registered Copyright 2012  G.A. Korn    original file was 4/17/93 */
...
double vaik(int arow,int acol,int abase,int xxbase,int k)         /* A*x */
{
    int j ;  double val ;   
...
double vaki(int arow,int acol,int abase,int xxbase,int k)   /* A%*x */
{
    int j ; double val ;
