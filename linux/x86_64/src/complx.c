...
void cvalexp(double *A, double *B)   /* complex expression */
...
/* ------------------------------------------------------------------ */
	...
	if (p->valptr>0) {                 /* user-defined function */
		...
		/*exp*/ 
		case  -5  : a=exp(arg)*cos(sign) ; b=exp(arg)*sin(sign) ;
		    break ;
		    
		    /*Conjug*/ 
		case -18  : a=arg ; b= -sign ; break ;
		    /*expj*/ 
		case -19  : a=cos(arg) ; b=sin(arg) ; break ;
