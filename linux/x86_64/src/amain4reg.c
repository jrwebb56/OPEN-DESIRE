/*    DESIRE - Direct Executing SImulation in REal time  - LINUX       */

/*  amain4reg.c - main DESIRE program, global variables                */

/*    REGISTERED COPYRIGHT 2012 by Granino A. Korn                     */
...
/***	       7/25/05  added new func1, func2  	               */ 
/*           added zz command                               11/21/06   */     
/**		   5/4/09    added gauss                         */

/***         this is the REGISTER version, not portable      8/20/05  **/
/*** this NEW 64-bit VERSION 11/21/06 has 3 register variables, zz command ***/
/**      new version interchanges keep, keep+; list, list+    8/15/07 **/
/*            added AVG                                       1/14/12  */
...
zz$delta$DELTA$Vector$Mat d/dt$Delta$func2$vv$Vectr d/dt$Vectr delta$\
SUBMODEL$AVG$" ; 
...
int   jcstart, jdstart ;             /* compiler-array indices */
/* ------------------------------------------------------------------- */
