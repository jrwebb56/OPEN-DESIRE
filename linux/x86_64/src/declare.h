...
/*           OPEN DESIRE for Linux                                      */
/*    REGISTERED COPYRIGHT 2008 by Granino A. Korn                     */
...
/***  increased size   3/17/97, 4/19/97 ,8/4/98, 2/14/99, 
      			   9/14/02, 8/25/05    <***/
/**   introduced Vectr d/dt, Vectr delta, SUBMODEL              9/13/02 **/
/**  increased varsize (identifier length) to 20                7/5/08  **/

/*** increased  maxrlvar,maxhash. EQMAX  2/28/10      **/ 
/**  increased maxnam to 90 for Ubuntu 10   5/22/10    **/
/* ------------------------------------------------------------------- */
...
#define     maxnam 120         /* path name size - incl. extension etc. */
#define     maxdim 10         /* max. number of dimensions in an array */
#define     varsize 20         /* max. identifier length, also in DEF */
#define     maxcmd 55         /* max. length of command string */
#define     maxhash 599      /* length of hash table */
...
#define     maxrlvar 800000  	 /* max. number of REAL variables  $$$$$  <****/
#define     maxnsv 40000      /* max. number of state variables $$$$$ <**ok**/
#define     maxsysp 25        /* max. number of simulation parameters */
#define     mmm maxnsv+4      /* a base in relval array */
#define     EQUMAX 1000        /* max. number of GEAR etc. state vars. $$$$$ <**ok**/
