/* EXCUT.C     Commands for DESIRE Interpreter  - LINUX                */
/*             Registered Copyright 2001  G.A. Korn                    */
...
extern void vector() ;  extern void matrix() ;  extern void dot() ;
...
ptr getvar()  {           /* look up variable and type, return pointer */
  ...
  register unsigned char curr ; int lj ;  ptr P ;
       ...
       if (curr>='A' && curr<='Z' ||        /* 1st char. must be alpha */
            curr>='a' && curr<='z') goto L7 ;
...
void execute() { /*  interprets statements ; switch sequence matches
   ...
   int lj, sub ;  double val1, val2 ; ptr  q ;
...
L10 : switch (warea[gi-1]) {
 ...
 /* end while */ case 19  :
  ...
  /* drunr */   case 23   : drun00() ; srun() ; reset0() ; break ;
...
/* discn'ct */  case 46   : closef() ; break ;
  ...
  /* drun */    case 48   : drun00() ; srun() ; break ;
  /* list+  */  case 49   : prfile(0) ; break ;
  /* new */     case 50   : new00(0) ; system("csh ./ekiller.old") ; break ;
...
/* dimension */ case 59   : declare(0) ; break ;
  ...
  /* edit */    case 60  : prfile(-2) ; system("clear") ; break ;
 /* auto */     case 61   : auto0() ; system("clear") ; break ;
  /* ed */      case 62   : spare4=1 ; prfile(-5) ; break ;

  /* bye */     case 63   : system("clear") ; SPARE4=1 ;
                            system("csh ./ekiller.old") ;
