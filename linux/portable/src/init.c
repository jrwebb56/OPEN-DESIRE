...
/*             changed initial message                         5/12/99 */
/*                                                                     */
...
/* extern  void  sign() ;  */           /* displays NEUNET header line */
...
void dummy(ss)          /* installs predefined symbols in symbol table */
                                                   /* CALLED BY prepr1 */
   STRING ss ; {
...
void prepr1() {     /* clear/restore data values; clear compiler area; */
   ...
   /** spare2=1 ;                 **/          /* normally poll graphs */

   bdummy=0 ;                                  /* thin dots is default */
   stashflag=0 ;                                  /* no SYSPIC.DAT yet */
   spare4=0 ;              /* spare4 suppresses error message after ed */
...
void initialize() {        /* setup, initial display, get command line */
   ...
   editflg=SPARE1=SPARE3=SPARE4=0 ;                      /* edit flags */ 
   ...
   X=340 ; Y=23 ;                                /* initial display position */
