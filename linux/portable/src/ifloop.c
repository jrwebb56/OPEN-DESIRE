...
switch(relop) {
     ...
     /*EQ*/   case 1 : if (exp1==exp2) return ; break ;
     /*LE*/   case 2 : if (exp1<=exp2) return ; break ;
     /*NE*/   case 3 : if (exp1!=exp2) return ; break ;
     /*LT*/   case 4 : if (exp1<exp2)  return ; break ;
     /*GE*/   case 5 : if (exp1>=exp2) return ; break ;
     /*GT*/   case 6 : if (exp1>exp2)  return ;
