...
/*             Registered Copyright 1993 G.A. Korn             8/21/93 */
...
extern void derror() ;  extern void derve1() ;
...
void ru4() {                             /*  RK 4/2 Variable-step Rule */
      ...
      register int  i ;  int  FO ;  double  time, dto6,
       hdt, rk3, dtem, fehler, fehlx, rk1[maxnsv+1], rk2[maxnsv+1],val ;
